...
void Window_SaveFile::Refresh() {
	...
	int i = 0;
	DrawFace(data.face1_name, data.face1_id, 92 + 70 + i++ * 56, 0, false);
	DrawFace(data.face2_name, data.face2_id, 92 + 70 + i++ * 56, 0, false);
	DrawFace(data.face3_name, data.face3_id, 92 + 70 + i++ * 56, 0, false);
	DrawFace(data.face4_name, data.face4_id, 92 + 70 + i++ * 56, 0, false);
}
